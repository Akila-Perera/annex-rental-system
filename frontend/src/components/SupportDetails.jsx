      ...
      <div className="max-w-[1100px] mx-auto relative z-10">
        ...
        <div className="flex justify-between items-end mb-8 flex-wrap gap-4">
          ...
          <button onClick={() => navigate('/support')}
            className="px-6 py-2.5 bg-blue-500 text-white border-none rounded-[14px] font-semibold cursor-pointer text-[0.92rem] whitespace-nowrap flex-shrink-0 hover:bg-blue-400 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/35 transition-all duration-300">
            + New Request
          </button>
        </div>
