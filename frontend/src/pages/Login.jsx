      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative pulse-ring w-14 h-14 mb-3">
            <div className="w-14 h-14 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-blue-600/30">
              U
            </div>
          </div>
          <h1 className="text-white text-3xl font-bold tracking-tight">UniNEST</h1>
          <p className="text-gray-500 text-xs mt-1 tracking-widest uppercase">Student Housing Platform</p>
        </div>
        ...
        <div className="bg-[#111827] border border-[#1f2a3c] rounded-2xl p-1.5 flex gap-1.5 mb-4">
          ...
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2
              ${activeTab === 'admin'
                ? 'bg-amber-500 text-[#0a0f1e] shadow-lg shadow-amber-500/30'
                : 'text-gray-500 hover:text-gray-300'}`}
          >
            🛡️ Admin Portal
          </button>
        ...
        ══════════════════════════════ */}
        <div
          className={`tab-slide ${activeTab === 'user' ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-4 pointer-events-none absolute w-full max-w-md'}`}
        >
          <div className="bg-[#111827] border border-[#1f2a3c] rounded-2xl p-8 shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mb-8">Log in to your student account to continue</p>

            {error && (
              <div className="bg-red-500/10 border border-red-500/30 text-red-400 text-sm rounded-lg px-4 py-3 mb-6 flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-gray-300 text-xs font-medium uppercase tracking-wider">Password</label>
        ...
        ══════════════════════════════ */}
        <div
          className={`tab-slide ${activeTab === 'admin' ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-4 pointer-events-none absolute w-full max-w-md'}`}
        >
            ...
            <form onSubmit={handleAdminSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <button
                    type="button" onClick={() => setShowAdminPass(!showAdminPass)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300 transition-colors"
                  >
